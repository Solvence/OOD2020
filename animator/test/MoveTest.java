...
public class MoveTest {
  ...
  public void setUp() {
    ...
    this.c3 = new Move(70, 75, new Position2D(2, 2), new Position2D(10, 25));
    ...
    this.s3 = new Rectangle(20, 12, new Color(10, 20, 10), new Position2D(2, 2));
  }
  ...
  public void testSameType() {
    ...
    assertFalse(c1.sameType(new ChangeSize(1, 2, new Dimension2D(1, 1), new Dimension2D(2, 3))));
  }
